...
/**
 *
 * @ORM\Table(name="item_order_relation")
 * @ORM\Entity
 * @ORM\HasLifecycleCallbacks
 */
class ItemOrderRelation
{
    /**
     * @var integer
     *
    ...
    /**
     * @var \Transaction\Entity\ItemOrder
     *
     * @ORM\ManyToOne(targetEntity="Transaction\Entity\ItemOrder")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="item_order_id", referencedColumnName="id", nullable=false, onDelete="CASCADE")
     * })
     */
    private $item_order;
