...
abstract class ObjectAutocomplete extends Text {
    ...
    public function setOptions($options) {
        if (!$this->initialized) {
            $this->setAttribute('placeholder',"Digite '*' para visualizar os primeiros resultados");
        ...
        $options['add-on-append'] = "<i class='glyphicon glyphicon-th-list'></i>";
