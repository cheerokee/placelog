 ...
 */
class EventAddress extends \Event\Entity\EventAddress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['name' => NULL, 'street' => NULL, 'number' => NULL, 'zipCode' => NULL, 'neighborhood' => NULL, 'latitude' => NULL, 'longitude' => NULL];
    ...
    {
        unset($this->name, $this->street, $this->number, $this->zipCode, $this->neighborhood, $this->latitude, $this->longitude);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'street', 'number', 'zipCode', 'neighborhood', '' . "\0" . 'Event\\Entity\\EventAddress' . "\0" . 'city', '' . "\0" . 'Event\\Entity\\EventAddress' . "\0" . 'state', '' . "\0" . 'Event\\Entity\\EventAddress' . "\0" . 'event', 'latitude', 'longitude'];
        }

        return ['__isInitialized__', 'id', '' . "\0" . 'Event\\Entity\\EventAddress' . "\0" . 'city', '' . "\0" . 'Event\\Entity\\EventAddress' . "\0" . 'state', '' . "\0" . 'Event\\Entity\\EventAddress' . "\0" . 'event'];
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventAddress $proxy) {
