 ...
 */
class App extends \App\Entity\App implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\App' . "\0" . 'id', '' . "\0" . 'App\\Entity\\App' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entity\\App' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\App' . "\0" . 'name', '' . "\0" . 'App\\Entity\\App' . "\0" . 'company', '' . "\0" . 'App\\Entity\\App' . "\0" . 'type_app', '' . "\0" . 'App\\Entity\\App' . "\0" . 'integration'];
        }
    ...
    public function getTypeApp()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTypeApp', []);

        return parent::getTypeApp();
    }
    ...
    public function setTypeApp($type_app)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeApp', [$type_app]);

        return parent::setTypeApp($type_app);
    }
