 ...
 */
class Configuration extends \Register\Entity\Configuration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['title' => NULL, 'chave' => NULL, 'value' => NULL];
    ...
    {
        unset($this->title, $this->chave, $this->value);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'title', 'chave', 'value'];
        }
