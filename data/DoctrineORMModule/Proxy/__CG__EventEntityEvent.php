...
class Event extends \Event\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Event\\Entity\\Event' . "\0" . 'updatedAt', '' . "\0" . 'Event\\Entity\\Event' . "\0" . 'createdAt', '' . "\0" . 'Event\\Entity\\Event' . "\0" . 'active', 'title', 'description', '' . "\0" . 'Event\\Entity\\Event' . "\0" . 'person'];
        }
