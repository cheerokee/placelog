...
class Category extends \Blog\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'updatedAt', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'createdAt', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'id', 'name', 'numberOrder', 'active', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'category', 'friendly_url'];
        }
    ...
    public function getNumberOrder()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumberOrder', []);
    ...
    public function setNumberOrder($numberOrder)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumberOrder', [$numberOrder]);
