 ...
 */
class Text extends \Site\Entity\Text implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Site\\Entity\\Text' . "\0" . 'updatedAt', '' . "\0" . 'Site\\Entity\\Text' . "\0" . 'createdAt', '' . "\0" . 'Site\\Entity\\Text' . "\0" . 'id', 'title', 'key', 'text'];
        }
