...
class Product extends \Catalog\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Catalog\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'Catalog\\Entity\\Product' . "\0" . 'updatedAt', '' . "\0" . 'Catalog\\Entity\\Product' . "\0" . 'createdAt', '' . "\0" . 'Catalog\\Entity\\Product' . "\0" . 'company', '' . "\0" . 'Catalog\\Entity\\Product' . "\0" . 'name', '' . "\0" . 'Catalog\\Entity\\Product' . "\0" . 'friendly_url'];
        }
