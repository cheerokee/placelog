 ...
 */
class Profile extends \Register\Entity\Profile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['name' => NULL, 'chave' => NULL, 'information' => NULL];
    ...
    {
        unset($this->name, $this->chave, $this->information);
